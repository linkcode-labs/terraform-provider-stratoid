...
type OnAuthenticationMethodLoadStart struct {
	ODataType         string              `json:"@odata.type,omitempty"`
	IdentityProviders *[]IdentityProvider `json:"identityProviders,omitempty"`
}

type OnInteractiveAuthFlowStart struct {
	ODataType       string `json:"@odata.type,omitempty"`
...
type BaseIdentityUserFlowImpl struct {
	...
	OnInteractiveAuthFlowStart      *OnInteractiveAuthFlowStart      `json:"onInteractiveAuthFlowStart,omitempty"`
	OnAuthenticationMethodLoadStart *OnAuthenticationMethodLoadStart `json:"onAuthenticationMethodLoadStart,omitempty"`
}
...
func UnmarshalIdentityUserFlowImplementation(input []byte) (IdentityUserFlow, error) {
	...
	if strings.EqualFold(value, "#microsoft.graph.externalUsersSelfServiceSignUpEventsFlow") {
		var out BaseIdentityUserFlowImpl
